                     ...
                     <div className="checkbox-list">
                        ...
                        <label className="checkbox">
                           <input
                              ...
                              checked={
                                 formik.values.someoneAddsYouAsAsAConnection
                              }
                              onChange={formik.handleChange}
                           />
                     ...
                     <div className="checkbox-list">
                        <label className="checkbox">
                           <input
                              ...
                              onChange={formik.handleChange}
                           />
                           <span></span>News about Keenthemes products and
                           feature updates
                        </label>
                        <label className="checkbox">
                           <input
                        ...
                        <label className="checkbox">
                           <input
                              ...
                              onChange={formik.handleChange}
                           />
                           <span></span>News about Metronic on partner products
                           and other services
                        </label>
                        <label className="checkbox">
                           <input
                              ...
                              checked={
                                 formik.values.tipsOnMetronicBusinessProducts
                              }
                              onChange={formik.handleChange}
                           />
